...
class SmallRing : AppCompatActivity() {
    private lateinit var binding: ActivitySmallRingBinding

    private val adapter = PlantAdapter()

    private val imageIdList = listOf(
        R.drawable.bogolubovo1, R.drawable.ivanovo1,
    ...
    private val titleTextList = listOf(
        "Боголюбово", "Иваново", "Кострома", "Сергиев Пассад",
        "Ярославль", "Переславль", "Ростов"
    )

    private val infoTextIdList = listOf(
        R.string.tv_bogolubovo, R.string.tv_ivanovo,
    ...
    override fun onStart() {
        super.onStart()
        Toast.makeText(this, "onStart called" + getString(R.string.toast_info), Toast.LENGTH_SHORT)
            .show()
    }
    ...
    private fun init() {
        binding.apply {
            ...
            btnNextTown.setOnClickListener {
                if (index > 6) index = 0
                val plant =
                    RingPlant(imageIdList[index], titleTextList[index], infoTextIdList[index])
